...
$price1 = $_REQUEST['price1'];//商品price
$price2 = $_REQUEST['price2'];//商品price
...
if($rows>0){
	...
	$sql = "INSERT INTO `cart` (`product_id`,`product_img`,`product_price1`,`product_price2`,`product_num`) VALUES ('$id','$img','$price1','$price2','$num')";
}
